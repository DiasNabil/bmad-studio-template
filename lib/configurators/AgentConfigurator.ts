...
class AgentConfigurator {
    private agentDependencyMap: { [key: string]: string[] };
    private configurationCache: Map<string, any>;
    ...
    async configure(analysis: Analysis) {
    ...
    private resolveAgentDependencies(agents: string[], analysis: Analysis): string[] {
    ...
    private selectSpecializedAgents(analysis: Analysis): string[] {
        const agents: string[] = [];
    ...
    private selectWorkflows(analysis: Analysis): string[] {
    ...
    private generateAgentConfig(analysis: Analysis): AgentConfiguration {
        const projectType = this.detectProjectType(analysis);
    ...
    private detectProjectType(analysis: Analysis): string {
        ...
        // Fallback detection
        if (analysis.architectureType === 'microservices') {
            return 'enterprise';
        }
        if (analysis.domain === 'e-commerce') {
            return 'marketplace';
        }
    ...
    private generateCacheKey(analysis: Analysis): string {

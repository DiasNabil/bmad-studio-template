...
╚═════╝ ╚═╝     ╚═╝╚═╝  ╚═╝╚═════╝     ╚══════╝   ╚═╝    ╚═════╝ ╚═════╝ ╚═╝ ╚═════╝
  ...
  async configureProjectInfrastructure() {
    ...
    try {
      ...
      this.projectData.agentConfig = await this.agentConfigurator.configure(this.projectData.analysis);
      ...
      this.projectData.mcpConfig = await this.configureMCP();

      spinner.succeed('✅ Infrastructure configurée');

      console.log(chalk.green(`🤖 ${this.projectData.agentConfig.selectedAgents.length} agents configurés`));
